...
data.raw["optimized-decorative"]["cane-cluster"].autoplace.max_probability = 0.1 -- not originally in it
data.raw["optimized-decorative"]["cane-single"].autoplace.max_probability = 0.1 -- not originally in it
data.raw["optimized-decorative"]["puddle-decal"].autoplace.max_probability = 0.03 -- originally 0.1
	-- Also looks like they have a typo, puddle-decal.lua line says infleunce instead of influence. TODO notify them.
data.raw["optimized-decorative"]["sand-decal-white"].autoplace.max_probability = 0.03 -- not originally in it
data.raw["optimized-decorative"]["brown-asterisk-mini"].autoplace.max_probability = 0.1 -- not originally in it, I think.
...
data.raw["optimized-decorative"]["asterisk-mini-turquoise"].autoplace.max_probability = 0.1 -- not originally in it, I think.
data.raw["optimized-decorative"]["pita-blue"].autoplace.max_probability = 0.1 -- not originally in it, I think.
...
data.raw["optimized-decorative"]["pita-mini-turquoise"].autoplace.max_probability = 0.1 -- not originally in it, I think.
...
data.raw["optimized-decorative"]["croto-blue"].autoplace.max_probability = 0.1
