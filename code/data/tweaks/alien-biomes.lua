...
data.raw["optimized-decorative"]["asterisk-mini-yellow"].autoplace.max_probability = 0.08
...
data.raw["optimized-decorative"]["pita-mini-olive"].autoplace.max_probability = 0.08
...
data.raw["optimized-decorative"]["crater1-large-rare"].autoplace.max_probability = 0.1
