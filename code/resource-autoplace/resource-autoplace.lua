...
local function resource_autoplace_settings(params)
  ...
  local base_density = params.base_density or default.base_density
  ...
  local random_probability = params.random_probability or default.random_probability
  local base_spots_per_km2 = params.base_spots_per_km2 or default.base_spots_per_km2
  local random_spot_size_minimum = params.random_spot_size_minimum or default.random_spot_size_minimum
  local random_spot_size_maximum = params.random_spot_size_maximum or default.random_spot_size_maximum
  -- Amplitude of spot 'blob noise' relative to typical spot amplitude
  local regular_blob_amplitude_multiplier  = 1/8 * (params.regular_blob_amplitude_multiplier  or default.blob_amplitude_multiplier)
  local starting_blob_amplitude_multiplier = 1/8 * (params.starting_blob_amplitude_multiplier or default.blob_amplitude_multiplier)

  local control_setting      = noise.get_control_setting(autoplace_control_name)
  local frequency_multiplier = (params.freq_multiplier_coefficient or default.freq_multiplier_coefficient) * control_setting.frequency_multiplier
  local size_multiplier      = (params.size_multiplier_coefficient or default.size_multiplier_coefficient) * control_setting.size_multiplier
  ...
  local additional_richness = params.additional_richness or default.additional_richness
  ...
  local minimum_richness = params.minimum_richness or default.minimum_richness
  -- 'post' as in multiplied after everything else is calculated, including additional_richness
  -- and minimum_richness.
  local richness_post_multiplier = (params.richness_post_multiplier or default.richness_post_multiplier) * control_setting.richness_multiplier

  local seed1 = params.seed1 or default.seed
  ...
  local regular_rq_factor  = (params.regular_rq_factor_multiplier  or default.regular_rq_factor_multiplier)  * 1 / 10 * (params.regular_rq_factor_coefficient  or default.regular_rq_factor_coefficient)
  ...
  local candidate_spot_count = (params.candidate_spot_count or default.candidate_spot_count)
  ...
  local function regular_spot_quantity_base_at(dist)
    return regular_density_at(dist) * (params.base_quantity or default.base_quantity) / spots_per_km2_near_start
  end
  ...
  if startingAndEdge[params.name] == true then
    starting_resource_placement_ring_radius = 1500
