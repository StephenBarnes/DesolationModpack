...
require("stages.data.tweaks.IR3.scatterbots")
require("stages.data.tweaks.IR3.starting-junkheaps")
require("stages.data.tweaks.IR3.misc")
require("stages.data.tweaks.IR3.inspiration-costs")
require("stages.data.tweaks.IR3.geothermal")